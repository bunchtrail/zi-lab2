...
//    - отдельно получает K1 и K2 для последнего блока.
//
// 4. Делит сообщение:
//    - разбивает байты на блоки по 16;
//    - начинает с пустого 16-байтного результата.
//
// 5. Обрабатывает основные блоки:
//    - смешивает блок с текущим результатом через XOR;
//    - шифрует полученный блок «Кузнечиком».
//
// 6. Обрабатывает последний блок:
//    - если он полный, смешивает его с K1;
//    - если неполный, дополняет его и смешивает с K2.
//
// 7. Получает итог:
//    - шифрует последний результат;
